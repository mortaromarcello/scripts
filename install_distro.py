...
class MyFrame(wx.Frame):
  ...
  def goInstall(self):
    ...
    result = wx.MessageDialog(None, _("Attenzione! L'installazione formatterà la/le partizione/i del/dei disco/i! Sei Sicuro?"), _("Attenzione"), wx.YES_NO|wx.ICON_QUESTION).ShowModal()
