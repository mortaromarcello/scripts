...
class Glob(object):
    ...
    if grep('/etc/group', 'android'):
        GROUPS                = 'cdrom,floppy,audio,dip,video,plugdev,lp,dialout,netdev,android'
    else:
        GROUPS                = 'cdrom,floppy,audio,dip,video,plugdev,lp,dialout,netdev'
...
class MyPanel(wx.Panel):
    ...
    def initGui(self):
        ...
        grid_sizer2 = wx.FlexGridSizer(8, 2, padding, padding)
