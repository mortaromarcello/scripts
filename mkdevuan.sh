...
PACKAGES="vinagre telnet ntp testdisk recoverdm myrescue gnu-fdisk gpart diskscan exfat-fuse task-$DE-desktop wicd geany geany-plugins smplayer putty blueman"
USERNAME=devuan
PASSWORD=devuan
SHELL=/bin/bash
HOSTNAME=devuan
